...
def get_keyframe(videopath):
    ...
    if USE_LOCAL_MAXIMA:
        ...
        for i in frame_indexes:
            ...
            name = "keyframe_" + str(i) + ".png"
            cv2.imwrite(os.path.join(os.getcwd(), "blog", "yolo5", "msic", name), frame)
            print(os.path.join(os.getcwd(), "blog", "yolo5", "msic", name))
...
if __name__ == "__main__":
    ...
    videopath = 'E:\\research\\2022plan\\SewerDefectManage\\KeyFrame\\a7635cff6984a5bca8c3bc8233af893a.mp4'
    # Directory to store the processed frames
    dir = 'E:\\research\\2022plan\\SewerDefectManage\\KeyFrame\\a7635cff6984a5bca8c3bc8233af893a\\a7635cff6984a5bca8c3bc8233af893a_local\\'
